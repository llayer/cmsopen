...
in_path = "/afs/cern.ch/work/l/llayer/CMSSW_5_3_32/src/workspace/preselection/data/"
...
def check_sample(sample_name = "Run2011A_MultiJet", nano = True, isData = True):
    ...
    outfiles = glob.glob("/eos/user/l/llayer/opendata_files/preselection/" + sample_name + "/*.root")
