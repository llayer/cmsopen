...
OUTPUT_DIR=${EOS_HOME}/opendata_files/preselection/
echo "Output directory:" $OUTPUT_DIR

CMSSW_BASE=/afs/cern.ch/work/l/llayer/CMSSW_5_3_32
echo "CMSSW base:" $CMSSW_BASE

CONFIG=${CMSSW_BASE}/src/workspace/preselection/pre_sel.py
...
sed -i -e "s@file = ROOT.TFile*@file = ROOT.TFile( '"pre"' + '_${HASH}_${ID}.root', '"recreate"')  #@g" $CONFIG_COPY
...
# Copy output file
xrdcp -f pre_${HASH}_${ID}.root root://eosuser.cern.ch/${OUTPUT_DIR}/${PROCESS}/pre_${HASH}_${ID}.root
rm pre_${HASH}_${ID}.root
