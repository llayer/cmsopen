...
void ERF_DEBUG_tau_leg()
{
  ...
  TFile* f0;
  f0 = new TFile("TriggerEffHisto_match40_newTauID.root");
  ...
  text1 = new TLatex(0.15,0.94,"CMS Preliminary, #sqrt{s}=7 TeV - HLT_QuadJet40_IsoPFTau40");
  text1->SetNDC();
  ...
  TLegend *l = new TLegend(0.55,0.6,0.99,0.7);
  l->SetTextSize(0.022);
  l->SetTextFont(42);
  ...
  //l->AddEntry((TObject*)0, "HLT_QuadJet45_IsoPFTau45", "");
  //l->AddEntry((TObject*)0, " ", "");
  ...
  d->Print("tau_leg_quadjet40_isopftau40.pdf");
  d->Print("tau_leg_quadjet40_isopftau40.root");
